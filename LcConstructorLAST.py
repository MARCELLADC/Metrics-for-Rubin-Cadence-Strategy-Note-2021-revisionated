...
def main(ra,dec,distanceMod,Ebv,RunName,Dbfile,yearsStart,
         ...
         outputDir2,optionFile,modelName,do_remove_saturated,label):
...
#read the model of variable star
...
#definition of time and filters from simulation and add the noise
    ...
    LcTeoLSST=generateLC(time_lsst,filters_lsst,lcTheoric)
...
#Make the plot    
    ...
    if optionPlot:
        ...
        plotting_LSST('LC multipanel',lcTheoric['phase'],lcTheoric['u'],lcTheoric['phase'],lcTheoric['g'],
                         lcTheoric['phase'],lcTheoric['r'],lcTheoric['phase'],lcTheoric['i'],lcTheoric['phase'],
                         lcTheoric['z'],lcTheoric['phase'],lcTheoric['y'],
    ...
    return LcTeoLSST,LcTeoLSST_noised,lcTheoric,mv,index_notsaturated

#mv viene sovrascritto dal SaturationStacker


# !!! conteggio saturazione
