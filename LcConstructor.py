...
def mag_antilog(mag):
    ...
    flux=10.**(-mag/2.5)
    return flux
def ReadTeoSim_blend(lcTheoric=[],perc_blend=0.):
    ...
    fluxblend_u=flux_u+perc_blend*lcTheoric['mean_flux_u']
    fluxblend_g=flux_g+perc_blend*lcTheoric['mean_flux_g']
    fluxblend_r=flux_r+perc_blend*lcTheoric['mean_flux_r']
    fluxblend_i=flux_i+perc_blend*lcTheoric['mean_flux_i']
    fluxblend_z=flux_z+perc_blend*lcTheoric['mean_flux_z']
    fluxblend_y=flux_y+perc_blend*lcTheoric['mean_flux_y']
