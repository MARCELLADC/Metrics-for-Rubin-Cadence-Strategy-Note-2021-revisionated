...
def check(data,period,index,factor1):
    ...
    time_z=data['timez'][index['ind_notsaturated_z']]
    time_y=data['timey'][index['ind_notsaturated_y']]
    maxHole_u,numberOfHoles_u=qualityCheck(time_u,period,factor1)
    maxHole_g,numberOfHoles_g=qualityCheck(time_g,period,factor1)
    maxHole_r,numberOfHoles_r=qualityCheck(time_r,period,factor1)
    maxHole_i,numberOfHoles_i=qualityCheck(time_i,period,factor1)
    maxHole_z,numberOfHoles_z=qualityCheck(time_z,period,factor1)
    maxHole_y,numberOfHoles_y= qualityCheck(time_y,period,factor1)
    
    quality={'maxHole_u':maxHole_u,'maxHole_g':maxHole_g,'maxHole_r':maxHole_r,
             'maxHole_i':maxHole_i,'maxHole_z':maxHole_z,'maxHole_y':maxHole_y,
             'numberHoles_u':numberOfHoles_u,'numberHoles_g':numberOfHoles_g,'numberHoles_r':numberOfHoles_r,
             'numberHoles_i':numberOfHoles_i,'numberHoles_z':numberOfHoles_z,'numberHoles_y':numberOfHoles_y}
...
def computation(data,index,period,numberOfHarmonics,factorForDimensionGap,label,outDir):
    ...
    finalResult={'mean_u':meanMag_u,'mean_g':meanMag_g,'mean_r':meanMag_r,
            ...
            'fittingParametersAllband':fitting,
                  'maxHoleDimension_u':quality['maxHole_u'],
                  'maxHoleDimension_g':quality['maxHole_g'],
                  'maxHoleDimension_r':quality['maxHole_r'],
                  'maxHoleDimension_i':quality['maxHole_i'],
                  'maxHoleDimension_z':quality['maxHole_z'],
                  'maxHoleDimension_y':quality['maxHole_y'],
                  'numberOfHoles_u':quality['numberHoles_u'],
                  'numberOfHoles_g':quality['numberHoles_g'],
                  'numberOfHoles_r':quality['numberHoles_r'],
                  'numberOfHoles_i':quality['numberHoles_i'],
                  'numberOfHoles_z':quality['numberHoles_z'],
